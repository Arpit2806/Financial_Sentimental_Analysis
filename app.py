...
# -------------------------------
# 🎨 CYBER FINTECH DARK THEME
# -------------------------------
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;800&display=swap');

/* Apply font & dark background to the entire app */
...
.stApp {
    ...
    background-image: radial-gradient(circle at top right, #1e1b4b, #0b0f19);
}
...
/* Customizing Streamlit standard elements to fit dark theme */
.stMarkdown em {
    color: #fbbf24;
}
</style>
...
with col2:
    ...
    <div class="cyber-card">
        <h3>📊 Capabilities</h3>
        <div style="background: rgba(255,255,255,0.03); padding: 10px; border-radius: 8px; margin-bottom: 10px; border-left: 3px solid #06b6d4;">
        ...
        <div style="background: rgba(255,255,255,0.03); padding: 10px; border-radius: 8px; border-left: 3px solid #06b6d4;">
